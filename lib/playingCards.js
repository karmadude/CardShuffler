...
if (Array.indexOf === undefined) {
 ...
 (function(window,document,undefined){
    ...
    playingCards.prototype.init = function() {
        ...
        for (i = 0; i < o.decks; i++) {
            ...
            for (s in o.suits) {
                for (r in o.ranks) {
                    l = this.cards.length;
                    this.cards[l] = new playingCards.card(index, r, o.ranks[r], s, o.suits[s]);
                    index++;
                }
            }
            // jokers
            for (i = 0; i < o.jokers; i++) {
                ...
                this.cards[l] = new playingCards.card(index, "N", o.jokerText, (i % 2) + 1, '');
            }
        }
    };
	 ...
	 */
    playingCards.card = function(index, rank, rankString, suit, suitString, conf) {
